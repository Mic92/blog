...
In this article, I will discuss the issue of running pre-compiled executables on
NixOS and how we can improve the user experience with [nix-ld](https://github.com/Mic92/nix-ld) by making these
binaries work seamlessly.
